...
<body>
    ...
    <nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
		...
		<li class="nav-item  active ">
            <a href="{{ route('jenis_surat.index')}}" class="nav-link">
		        <span class="sidebar-icon">
    ...
    <main class="content">
        ...
        <div class="py-4">
            ...
            <div class="d-flex justify-content-between w-100 flex-wrap">
                ...
                <div>
                    <a href="{{route('jenis_surat.index')}}" class="btn btn-primary"><i class="far fa-question-circle me-1"></i> Kembali</a>
                </div>
            </div>
        </div>
                        ...
                        <form action="{{ route('jenis_surat.store')}}" method="POST">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-lg-4 col-md-6 mb-3">
                                    ...
                                    <input name="kode" type="number" id="kode" class="form-control" placeholder="Masukkan kode surat" required>
                                </div>

                                <!-- Nama Jenis Surat -->
                                <div class="col-lg-4 col-md-6 mb-3">
                                    <label for="nama_jenis" class="form-label">Nama Jenis Surat</label>
                                    <input name="nama_jenis" type="text" id="nama_jenis" class="form-control" placeholder="Masukkan nama jenis surat" required>
                                </div>

                                <!-- Syarat JSON -->
                                <div class="col-lg-4 col-md-12 mb-3">
                                    <label for="syarat_json" class="form-label">Syarat Json</label>
                                    <input name="syarat_json" type="text" id="syarat_json" class="form-control" placeholder="Masukkan syarat json" required>
                                </div>
                            </div>
                            ...
                            <div class="mt-3">
                                ...
                                <a href="{{ route('jenis_surat.index') }}" class="btn btn-outline-secondary ms-2">Batal</a>
                            </div>
                        </form>
